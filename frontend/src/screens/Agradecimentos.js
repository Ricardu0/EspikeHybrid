            ...
            <View style={styles.contentWrapper}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>
                        Este projeto não existiria sem o esforço e dedicação de cada um abaixo.
                        Obrigado por fazer parte do E-Spike.
                    </Text>
                </View>
                ...
                <Text style={styles.closing}>
                    Obrigado a todos que contribuíram, direta ou indiretamente, para tornar este projeto realidade.
                </Text>
